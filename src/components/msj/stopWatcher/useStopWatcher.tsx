...
import { numberArrToStringTime, stringTimeToNumberArr } from "../util/timerTrans"
...
타입스크립트는 타입추론을 기본적으로 진핸한다. 그런데 window.setTimeout이 아닌, setTimeout​을 적게된다면, NodeJS.Timer을 반환하게된다. 그렇기에 정말 심플하게 해결하기 위해서는 any 타입을 써도되지만(하지만 typescript를 쓰는 이유가 사라지게됨), 습관적으로 timer 메소드앞에는 window.를 붙여주도록 하자.
